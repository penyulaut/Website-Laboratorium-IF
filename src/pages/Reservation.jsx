  ...
  return (
    <section className="py-9" id="reservasi">
      <div className="mx-auto px-4 max-w-2xl">
        <h1 className="text-4xl font-extrabold text-violet-800 mb-6">Reservasi Lab</h1>
        <form onSubmit={submit} className="bg-zinc-800 p-6 rounded-xl space-y-4">
          <div>
            <label className="block text-sm mb-1">Nama</label>
            <input name="name" value={form.name} onChange={onChange} required className="w-full p-2 rounded bg-zinc-900 border border-zinc-700" />
          </div>
          <div>
            <label className="block text-sm mb-1">Email</label>
            <input type="email" name="email" value={form.email} onChange={onChange} required className="w-full p-2 rounded bg-zinc-900 border border-zinc-700" />
          </div>
          <div>
